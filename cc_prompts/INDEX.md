...
| CC_PROMPT_v2.35.13.md | v2.35.13 | fix(agents): DB-sourced fallback + per-host dedup + best_snippet + pbs_datastore_health + agent_performance_summary tools | RUNNING |
