...
Pure refactor of the for-tc dispatch block — zero logic change.
"""
...
async def dispatch_tool_calls(
    ...
    *,
    ...
    Covers: destructive pre-flight, global lock check, batch-budget trim,
    the per-tc for-loop (plan_action/clarifying_question/propose_subtask/
    escalate/audit_log handlers + generic MCP fallthrough), auto-verify,
    audit writes, fact-age rejection, GUI stream, and tool-result append.
    """
