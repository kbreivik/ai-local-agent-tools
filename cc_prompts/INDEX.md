...
| CC_PROMPT_v2.45.18.md | v2.45.18 | fix(agent): clarify→plan_action — append system message to LLM messages list | DONE (87b5ac6) |
...
| CC_PROMPT_v2.45.28.md | v2.45.28 | feat(ui): Trend tab suite filter + Compare tab run-picker filters | DONE (dc3ba92) |
...
| CC_PROMPT_v2.49.12.md | v2.49.12 | feat(tests): suite-level cancel button (POST /api/tests/cancel + GUI) | RUNNING |
| CC_PROMPT_v2.49.13.md | v2.49.13 | feat(tests): suite-level auto_approve_all flag (override per-case auto_confirm via suite config) | PENDING |
