...
| CC_PROMPT_v2.35.11.md | v2.35.11 | fix(agents): forced_synthesis placeholder defence + fabrication regex tightening + attempt-1 cleaned-history promotion | RUNNING |
