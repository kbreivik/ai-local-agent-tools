...
| CC_PROMPT_v2.36.8.md | v2.36.8 | feat(agents): result_render_table + render-and-caption grammar (dark launch) | RUNNING |
...
api/logger.py                             — log_operation kwarg forwarding + log_operation_complete backfill from agent_llm_traces (v2.36.7)
tests/test_operations_model_column.py     — insert seed + complete-time backfill regression tests (v2.36.7)
mcp_server/tools/render_tools.py          — result_render_table MCP tool + column heuristic + markdown rendering (v2.36.8)
tests/test_render_tool.py                 — render tool regression tests + allowlist guards (v2.36.8)
